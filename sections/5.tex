    ...
    \begin{enumerate}
        ...
        \item  $(2)\Rightarrow (3)$ 
            ...
            Определение непрерывности в 0:
             ...
             Берем произвольный $x \rightarrow \overline{x} = x\frac{\delta}{\norm{x}}
             \Rightarrow \norm{U\overline{x}} \leqslant  \varepsilon \Leftrightarrow \frac{\delta}{\norm{x}} \cdot \norm{Ux} \leqslant \varepsilon \Leftrightarrow \norm{Ux} \leqslant \frac{\varepsilon}{\delta}  \norm{x}$.
             
             Тогда берем произвольный $\varepsilon$, строим для него $\delta$ и получаем $C = \frac{\varepsilon}{\delta}$. 
        \item $(3)\Rightarrow(1)$
