...
\begin{proof}
    ...
    $\int_a^{\to b} $ --- сх-ся $\Longleftrightarrow \lim\limits_{B \to b-} F(B) \Longleftrightarrow \forall \varepsilon > 0 \,\, \exists \delta \in [a, b) \,\, : \forall B_1, B_2  \in (\delta, b) \Rightarrow \\ \abs{F(B_1) - F(B_2)} < \varepsilon$ --- критерей Коши для функций.
\end{proof}
