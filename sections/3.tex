...
\begin{theorem}[о погрешности в формуле трапеций, продолжение]
...
\begin{remark}
    Если $f \in C[a, b], b \in \R \hence \int\limits_a^{\to b} f dx = \int\limits_a^b f dx$
\end{remark}


\begin{theorem}[Критерий Коши]
    $\int\limits_a^{\to b} f dx $ сходится $\Longleftrightarrow \forall \varepsilon > 0\,\, \exists \delta \in [a, b) : \forall B_1, B_2 \in (\delta, b) \hence \abs{\int\limits_{B_1}^{B_2} f dx} < \varepsilon$
\end{theorem}
